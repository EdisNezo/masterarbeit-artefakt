...
export function Terminal() {
    ...
    return (
        <div className="h-48 bg-[#1e1e1e] border-t border-[#3e3e3e] flex flex-col text-white font-mono text-xs">
            <div className="flex items-center justify-between px-4 py-1.5 bg-[#1e1e1e] border-b border-[#2d2d2d]">
                ...
                <div className="flex items-center">
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-2 py-0.5 rounded text-[10px] font-medium transition-colors ${isTestRunning
